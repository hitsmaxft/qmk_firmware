...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = {
        ...
        { KC_LCTL,    KC_LGUI,    KC_LALT,    KC_SPC,    KC_RALT,    MO(1),    KC_LEFT,   KC_DOWN,   KC_RGHT,  KC_BSPC,   KC_BSLS,  KC_RSFT,   KC_NO  }
    },
    [1] = {
        { QK_BOOT,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,},
        { KC_NO,    KC_F23,  KC_F19,  KC_F20,  KC_F18,  /*BLE_DEL*/KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,},
    ...
    [2] = {
        ...
        { KC_LCTL ,KC_LGUI,KC_LALT,KC_SPC, KC_RALT,   MO(1),  KC_LEFT, KC_DOWN, KC_RGHT,  KC_BSPC, KC_BSLS,KC_NO,KC_NO }
    }
};
